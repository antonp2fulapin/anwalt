    ...
    <Section>
      <Container className="space-y-10">
        ...
        <div className="relative h-56 rounded-lg overflow-hidden border border-stone shadow-subtle">
          <Image
            src="https://images.unsplash.com/photo-1454165205744-3b78555e5572?auto=format&fit=crop&w=1600&q=80&sat=-8"
            alt="Ordner und Vertragsdokumente für ein Insolvenzverfahren"
            fill
