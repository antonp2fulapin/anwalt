  ...
  return (
    <Section>
      <Container className="space-y-10">
        ...
        />
        <div className="relative h-48 rounded-lg overflow-hidden border border-stone shadow-subtle">
          <Image
            src="https://images.unsplash.com/photo-1525182008055-f88b95ff7980?auto=format&fit=crop&w=1400&q=80&sat=-8"
            alt="Telefon und Notizblock für die Terminvereinbarung"
            fill
